from volatility3.framework.layers import arm, intel, mips, ppc
...
LINUX_ARCHS = ["Intel32", "Intel64", "AArch64", "MIPS64", "PPC32"]
"""Linux supported architectures"""
LINUX_ARCHS_LAYERS = [intel.Intel, arm.AArch64, mips.MIPS64, ppc.PPC32]
...
FRAMEWORK_ARCHS = ["Intel32", "Intel64", "AArch64", "MIPS64", "PPC32"]
"""Framework supported architectures"""
FRAMEWORK_ARCHS_LAYERS = [intel.Intel, arm.AArch64, mips.MIPS64, ppc.PPC32]
