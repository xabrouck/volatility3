from volatility3.framework.layers import arm, intel, mips
...
LINUX_ARCHS = ["Intel32", "Intel64", "AArch64", "MIPS64"]
"""Linux supported architectures"""
LINUX_ARCHS_LAYERS = [intel.Intel, arm.AArch64, mips.MIPS64]
...
FRAMEWORK_ARCHS = ["Intel32", "Intel64", "AArch64", "MIPS64"]
"""Framework supported architectures"""
FRAMEWORK_ARCHS_LAYERS = [intel.Intel, arm.AArch64, mips.MIPS64]
